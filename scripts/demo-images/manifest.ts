...
const ITEM_QUERIES: Record<string, string> = {
  // ABC Electronics
  "led-panel-40w": "LED panel light",
  "led-bulb-9w-b22": "led light bulb",
  "street-light-120w": "led street light pole",
  "high-bay-150w": "warehouse lighting",
  "copper-cable-2-5mm": "electrical wire copper",
  "control-cable-4core": "electrical cable reel",
  "junction-box-6way": "electrical junction box",
  "service-lighting-design-consultation": "office lighting ceiling",
  "service-installation-commissioning": "electrician installing light fixture",
  "service-amc-maintenance": "electrician working",
  // Verma Plastics
  "ldpe-packaging-film": "polyethylene film",
  "moulded-closures": "plastic bottle caps",
  "shrink-sleeve": "shrink wrap",
  "service-custom-extrusion": "plastic extrusion machine",
  "service-contract-packaging": "packaging factory",
  // Sharma Steel
  "tmt-bar-12mm-fe500d": "rebar bundle",
  "tmt-bar-16mm-fe500d": "rebar construction site",
  "ms-square-pipe-50x50": "steel tubes",
  "gi-round-pipe-2-inch": "galvanized pipe",
  "service-cut-and-bend": "rebar bending worker",
  // MediCare
  "nitrile-gloves-powder-free": "nitrile gloves",
  "3-ply-surgical-mask": "surgical mask",
  "digital-bp-monitor": "digital blood pressure monitor",
  "stainless-surgical-scissors-set": "surgical instruments tray",
  "hospital-bed-semi-fowler": "hospital bed",
  ...
  "service-private-label-packing": "spice packets",
  // Rathi Auto Parts
  "brake-pad-set-commercial": "brake pads",
  "led-headlamp-h4-truck": "LED headlight",
  "two-wheeler-clutch-plate": "motorcycle clutch plates",
  "engine-oil-15w40-ci4": "motor oil",
...
const SELLER_QUERIES: Record<string, { gallery: string; cover: string }> = {
  "demo-abc-electronics": {
    gallery: "circuit board manufacturing",
    cover: "led lighting warehouse",
  },
  "demo-sharma-steel": { gallery: "rebar construction", cover: "steel warehouse" },
  "demo-medicare-supplies": { gallery: "medical supplies shelves", cover: "hospital corridor" },
  "demo-kerala-spice-co": { gallery: "spice market india", cover: "spices bowls" },
  "demo-rathi-auto-parts": { gallery: "car engine parts", cover: "auto parts store" },
  "demo-verma-plastics": { gallery: "plastic factory machine", cover: "tarpaulin" },
};
...
const CATEGORY_QUERIES: Record<string, string> = {
  ...
  "rubber-products": "tyres stack",
  "metals-minerals": "steel coils",
  ...
  "handicrafts-decor": "brass handicraft",
  ...
  "safety-security": "CCTV camera",
  "bags-luggage-industrial": "jute sacks bags",
  "books-media": "stack of books",
  ...
  "printing-signage": "printing press",
...
const SUBCATEGORY_QUERIES: Record<string, string> = {
  ...
  "medical-disposables": "latex gloves",
